...
export class Messages implements OnInit {
  ...
  loadMessages(){
    this.messageService.getMesages(this.container, this.pageNumber, this.pageSize).subscribe({
      next: res => {
  ...
  async confirmDelete(event: Event, id: string){
    ...
    const ok = await this.confirmDialog.confirm('Are you sure you want ot delte this message?')
