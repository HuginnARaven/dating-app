...
export class MemberList implements OnInit {
  ...
  loadMembers(){
    this.memberService.getMembers(this.memberParams).subscribe({
      next: res => this.paginatedMembers.set(res),
  ...
  onModalClose() {
    console.log("[filterModal]: onModalClose called");
  }
  ...
  get displayFilltersMessage(): string{
    ...
    switch (this.updatedParams.orderBy) {
      case 'lastActive':
