...
namespace API.Controllers
{
    ...
    public class MembersController(IUnitOfWork uow, IPhotoService photoService) : BaseApiController
    {
        ...
        {
            Member? member = await uow.MemberRepository.GetMemberById(id);
        ...
        public async Task<ActionResult> UpdateMember(MemberUpdateDto memberUpdateDto)
        {
            ...
            uow.MemberRepository.Uppdate(member);
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            var photo = member.Photos.SingleOrDefault(x => x.Id == photoId);
            if (photo == null || member.ImageUrl == photo.Url) return BadRequest("Cannot delete photo");
